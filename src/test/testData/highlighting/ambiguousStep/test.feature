Feature: Some interesting feature
  ...
  Scenario: Consumption of a cookie
    ...
    And <warning descr="Ambiguous step reference with 2 definitions: current branch foo"><info descr="null">current </info>branch <info descr="null">foo</info></warning>
    When <warning descr="Ambiguous step reference with 2 definitions: current branch bar"><info descr="null">current </info>branch <info descr="null">bar</info></warning>
